...
Bütün ölçümler tek sayfada. **2026-09-04 11:25** tarihinde `savings.py` tarafından üretildi —
elle düzenlenmiyor.
...
|---|---|
| **Tasarruf** | **$354 · −26%** |
| Ölçülen gerçek harcama | $985.05 · 143 istem · 3,613 tur |
| Aynı iş `full` config'iyle | $1,339 |
| Üst sınır (en iyi ölçülen tur) | $1,041 · −51% |
...
| kalem | token | pay |
|---|---|---|
| cache okuma (konuşmayı yeniden okumak) | 1,368,596,761 | %69 |
| girdi + cache yazma | 18,720,325 | %19 |
| çıktı | 4,662,850 | %12 |
