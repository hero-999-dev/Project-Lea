...
Bütün ölçümler tek sayfada. **2026-09-04 11:53** tarihinde `savings.py` tarafından üretildi —
elle düzenlenmiyor.
...
|---|---|
| **Tasarruf** | **$355 · −26%** |
| Ölçülen gerçek harcama | $989.70 · 145 istem · 3,633 tur |
| Aynı iş `full` config'iyle | $1,345 |
| Üst sınır (en iyi ölçülen tur) | $1,046 · −51% |
...
| kalem | token | pay |
|---|---|---|
| cache okuma (konuşmayı yeniden okumak) | 1,376,274,091 | %69 |
| girdi + cache yazma | 18,741,088 | %19 |
| çıktı | 4,686,717 | %12 |
